...
public class LogAuditoria {
    ...
    public static LogAuditoria sucesso(String operacao, UUID entidadeId, String detalhe) {
        return new LogAuditoria(null, "posVendaAuto", operacao, entidadeId, Resultado.SUCESSO, detalhe, Instant.now());
    }

    public static LogAuditoria erro(String operacao, UUID entidadeId, String detalhe) {
        return new LogAuditoria(null, "posVendaAuto", operacao, entidadeId, Resultado.ERRO, detalhe, Instant.now());
    }
}
