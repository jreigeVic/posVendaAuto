...
public class LogAuditoriaJpaEntity {
    ...
    public static LogAuditoriaJpaEntity sucesso(String operacao, UUID entidadeId, String detalhe) {
        return new LogAuditoriaJpaEntity(null, "posVendaAuto", operacao, entidadeId, Resultado.SUCESSO, detalhe, Instant.now());
    }

    public static LogAuditoriaJpaEntity erro(String operacao, UUID entidadeId, String detalhe) {
        return new LogAuditoriaJpaEntity(null, "posVendaAuto", operacao, entidadeId, Resultado.ERRO, detalhe, Instant.now());
    }
}
